"""GET /pain-reports/{reportId} — Get a single pain report."""
...
from src.services.pain_report import get_pain_report
...
def _handler(event, context):
    ...
    report = get_pain_report(user_id, params["reportId"])
    return success(report)


handler = wrap_handler(_handler, "getPainReport")
